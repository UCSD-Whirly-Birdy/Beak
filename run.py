...
global_ivc.add_output('AR', val = 5)
...
prob.model.connect('hover_analysis_group.inputs_comp.speed', ['hover_analysis_group.hover_propulsion_group.rotational_rotor_group.speed', 'hover_analysis_group.hover_propulsion_group.vertical_rotor_group.speed'])
